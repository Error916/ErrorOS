...
// data took mostly from https://www.pcilookup.com/
...
const char* MassStorageControllerSubclassName(uint8_t subclassCode){
	...
	return u8to_hstring(subclassCode);
}
